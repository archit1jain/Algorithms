...
logindetails(userid,pass,mobile,emailid,ini_balance,gender,acc_type,question,answer,Status)
values('"+username+"','"+pass+"','"+mobile+"','"+emailid+"','"+ini_balance+"','"+gender+"','"+acc_ty
pe+"','"+question+"','"+answer+"','Pending')";
